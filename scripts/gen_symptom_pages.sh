...
<meta charset="UTF-8">
<meta name="viewport" content="width=device-width, initial-scale=1.0">
<title>${area} ${sym} 접수 안내 | 뉴월드</title>
<meta name="description" content="${area} ${sym} 접수 안내. ${desc}, 접수 즉시 확인 후 신속하게 연결해 드립니다.">
<meta name="robots" content="noindex, nofollow">
<!-- TODO: 정식 오픈 시 위 robots 메타태그 제거, canonical 추가 -->
<link rel="stylesheet" href="../css/style.css?v=1">
</head>
...
<section class="case-article">
  <div class="wrap">
    ...
    <p>${desc}. ${area} 지역 접수 건은 확인 후 신속하게 연결해 안내해 드립니다. 현장 진단 후 견적에 동의하신 뒤에만 작업이 진행됩니다.</p>
    <h2>자주 묻는 질문</h2>
